      ...
      <div class=" flex flex-col p-4">
        <h1 class="flex flex-col">
          <span class="footerText text-4xl">Thank You</span><span
            class="footerText text-2xl">So Much from</span
          ><span class="footerText text-4xl md:text-6xl">MD SAKIB HASAN</span>
        </h1>
      </div>

      <div class=" flex flex-col px-4 justify-center">
        <a href="" class="footerText">About Me</a>
        <a href="" class="footerText">Projects</a>
